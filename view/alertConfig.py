...
# def display_alerts(user_email, user_role, user_project):
#     """
#     Display the alerts config with personalized content based on user's role and project
#     """
...
#     tab1, tab2 = st.tabs(["Fitbit Alerts", "EMA Alerts"])
    
#     with tab1:
#         st.subheader("Fitbit Alerts Config")
#         st.write("Configure your Fitbit alerts here.")
#         spreadsheet = Spreadsheet(
#             'usersPassRoles',
#             get_secrets().get('spreadsheet_key'),
#         )            
#         GoogleSheetsAdapter.connect(spreadsheet)
#         fitbits_alert_sheet = spreadsheet.get_sheet("fitbit_alerts_config", "fitbit_alerts_config")
#         fitbits_df = fitbits_alert_sheet.to_dataframe(engine="polars")

#         if fitbits_df.empty:
#             st.write("No alerts configured yet.")
#             fitbits_df = pl.DataFrame({
...
#     with tab2:
#         st.subheader("EMA Alerts Config")
#         st.write("Configure your EMA alerts here.")
