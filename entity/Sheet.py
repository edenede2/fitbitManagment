    ...
    def update_fitbits_log(self, spreadsheet:Spreadsheet, fitbit_data: pl.DataFrame, reset_total_for_watches=None) -> bool:
        ...
        try:
            ...
            for row in fitbit_data.iter_rows(named=True):
                ...
                # Create a provider-aware snapshot and update data via the right API.
                try:
                ...
                battery_supported = str(row.get("battery_supported", True)).upper() != "FALSE"
                battery_success = bool(row.get("battery")) or not battery_supported
                ...
                log_entry = {
                    ...
                    "lastBattary": now if row.get("battery") else ("N/A" if not battery_supported else ""),
                    ...
                    "lastBattaryVal": row.get("battery", "") if battery_supported else "N/A",
